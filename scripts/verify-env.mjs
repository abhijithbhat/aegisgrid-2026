...
const invalid = [];
if (!Number.isFinite(timeout) || timeout < 2_000 || timeout > 30_000)
  invalid.push("AI_TIMEOUT_MS must be between 2000 and 30000");
if (!Number.isInteger(retries) || retries < 0 || retries > 1)
  invalid.push("AI_MAX_RETRIES must be 0 or 1");
