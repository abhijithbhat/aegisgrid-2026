...
const description =
  "From fragmented stadium signals to one safe, explainable decision—human-approved incident fusion and response support for safety supervisors.";
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "AEGISGRID 2026 — From fragmented signals to one safe, explainable decision.",
        },
      ],
    },
