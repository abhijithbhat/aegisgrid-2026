    ...
    <main className="workspace-view data-lab-view">
      <div className="view-heading">
        ...
        <div className="view-heading-actions">
          ...
          <button type="button" className="danger-ghost-button" onClick={reset}>
      ...
      <div className="lab-security-bar">
      ...
      <div className="lab-grid">
        <section className="panel lab-source-panel">
          <div className="mode-switch" role="tablist" aria-label="Data input method">
            <button
              ...
              onKeyDown={(event) => {
                ...
                const next = event.key === "Home" ? "upload" : "text";
                setMode(next);
            ...
            <button
              ...
              onKeyDown={(event) => {
                if (!["ArrowLeft", "ArrowRight", "Home", "End"].includes(event.key)) return;
                event.preventDefault();
                const next = event.key === "End" ? "text" : "upload";
                setMode(next);
                window.requestAnimationFrame(() =>
                  document.getElementById(`lab-tab-${next}`)?.focus(),
                );
          ...
          {mode === "upload" ? (
            ...
            >
              ...
              <button
                ...
                onClick={() => void interpretTextReport()}
              >
              ...
              {textAnalysis.status === "unavailable" ? (
                <div className="form-error" role="status">
                  ...
                  <span>
                    <strong>AI analysis unavailable.</strong> {textAnalysis.message} The report has
                    not been interpreted or imported.
                  </span>
                </div>
              ) : null}
            </div>
          ...
          <div className="ingestion-steps">
            ...
            <span
              className={
                validation ? (validation.accepted ? "done" : "active") : file ? "active" : ""
              }
            >
        ...
        <section className="panel schema-panel">
          ...
          <p className="panel-description">
            Every mapping remains unapplied until you explicitly validate it. Confidence is
            advisory; strict normalization is deterministic.
          </p>
          {mappingNotice ? (
            <div className="text-safety-note">
          ...
          <div className="mapping-table" role="table" aria-label="Proposed schema mappings">
            ...
            {mapping.map((item, index) => (
              <div className="mapping-row" role="row" key={item.sourceColumn}>
                ...
                <span role="cell" className="mapping-arrow">
          ...
          <div className="mapping-actions">
            ...
            <button
              ...
              onClick={() => void validateApprovedMapping()}
            >
      ...
      <section className="panel preview-panel">
        <div className="panel-head">
          ...
          <div className="preview-status">
            <span>
              <i className={validation?.accepted ? "valid" : ""} />
              {validation?.summary.validRows ?? 0} valid
            </span>
            <span>
              <i className={(validation?.summary.errorCount ?? 0) ? "invalid" : "valid"} />
        ...
        {headers.length ? (
          ...
          <div className="empty-table">
            ...
            <span>
              Upload a supported CSV, JSON, or selectable-text PDF to inspect and map actual
              records.
            </span>
            ...
            <div className="empty-table-schema-guide">
              ...
              <p>
                Prepare your upload with headers matching or easily mappable to the canonical
                scheme:
              </p>
              <div
              ...
              <ul className="schema-field-list">
                <li>
                  <strong>timestamp</strong>: ISO 8601 string (e.g.,{" "}
                  <code>2026-07-17T10:00:00Z</code>)
                </li>
                <li>
