...
const paths: Record<IconName, React.ReactNode> = {
  ...
  team: (
    <>
      ...
      <path d="M3 21v-2a6 6 0 0 1 12 0v2M16 11h5M18.5 8.5v5" />
    </>
  ),
  "arrow-up": (
    <>
  ...
  spark: (
    <>
      ...
      <path d="m5 15 .8 2.2L8 18l-2.2.8L5 21l-.8-2.2L2 18l2.2-.8ZM19 3l.6 1.4L21 5l-1.4.6L19 7l-.6-1.4L17 5l1.4-.6Z" />
    </>
  ),
  evidence: (
    <>
  ...
  language: (
    <>
      <path d="M4 5h10M9 3v2M6 9c1.4 2.8 3.8 5 7 6M12 5c-.8 4-3.3 7.5-7 9" />
      <path d="m15 13 3 8M21 13l-3 8M16 18h4" />
    </>
  ),
  edit: (
    <>
  ...
  reset: (
    <>
      <path d="M4 7v5h5" />
      <path d="M5.5 16a8 8 0 1 0 .5-9l-2 5" />
    </>
  ),
  pause: (
    <>
  ...
  skip: (
    <>
      <path d="m5 5 10 7L5 19ZM19 5v14" />
    </>
  ),
  plus: (
    <>
  ...
  file: (
    <>
      ...
      <path d="M14 2v5h4M9 13h6M9 17h6" />
    </>
  ),
  trash: (
    <>
  ...
  headset: (
    <>
      ...
      <path d="M4 14h4v6H6a2 2 0 0 1-2-2ZM20 14h-4v6h2a2 2 0 0 0 2-2ZM16 20c0 1-1 2-3 2" />
    </>
  ),
  map: (
    <>
