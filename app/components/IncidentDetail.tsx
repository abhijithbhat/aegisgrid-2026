          ...
          >
            <div className="essentiality-control">
              <div>
                ...
                <span>
                  Compare the operational facts available with and without semantic reasoning.
                </span>
              </div>
              <button
                type="button"
            ...
            {comparePaths ? (
              ...
              >
                <article>
                  ...
                  <p>
                    Risk <strong>{incident.risk}/100</strong>. {incident.reports} reports remain
                    separate records. The engine can rank urgency and calculate a route, but it
                    cannot determine whether different wording describes the same event.
                  </p>
                  <ul>
            ...
            {reasoningProgress.length ? (
              <ol
                ...
                aria-label="Live AI reasoning status"
                aria-live="polite"
              >
            ...
            <div className="score-strip">
              <div className="risk-score-block">
                <div
                  ...
                  style={{ "--score": `${incident.risk * 3.6}deg` } as React.CSSProperties}
                >
                  <span>
                    <b>{incident.risk}</b>
                    <small>/100</small>
              ...
              {aiAvailable ? (
                <>
                  ...
                  <div
                    ...
                    aria-label={`${incident.confidence}% confidence`}
                  >
                ...
                <div className="ai-unavailable-inline">
                  ...
                  <div>
                    <strong>
                      {aiPending ? "AI analysis in progress" : "AI analysis unavailable."}
                    </strong>
                    <small>
                      {aiPending
            ...
            {aiAvailable ? (
              ...
              <div className="degraded-analysis-card">
                ...
                <span className="degraded-mode-tag">
                  {aiPending ? "VALIDATING" : "DEGRADED MODE"}
                </span>
              </div>
            )}
          </div>
              ...
              {editing ? (
                ...
                <ol className="action-sequence">
                  {incident.actions.map((action, index) => (
                    <li
                      key={action.text}
                      className={completed.includes(index) ? "is-complete" : ""}
                    >
                      <button
                        type="button"
        ...
        {tab === "routing" ? (
          ...
          >
            ...
            <div className="deterministic-notice">
              ...
              <span>
                <strong>Path integrity protected.</strong> Routes are calculated by the
                deterministic graph engine; AI explains but cannot create or alter path nodes.
              </span>
            </div>
          </div>
        ) : null}
                ...
                <article className="announcement-card">
                  ...
                  <footer>
                    <span>
                      ...
                      Estimated{" "}
                      {Math.max(5, Math.round(announcementDraft.split(/\s+/).length / 2.4))} seconds
                    </span>
                    <span>
