              ...
              <section className="evidence-section">
                ...
                <div className="evidence-list">
                  {incident.evidence.map((item, index) => (
                    <article key={item.source} style={{ "--index": index } as React.CSSProperties}>
                ...
                {incident.contradictoryEvidence.length ? (
                  <div className="contradiction-list">
                    {incident.contradictoryEvidence.map((item, index) => (
                      <article key={`${item.sources}-${index}`} style={{ "--index": index } as React.CSSProperties}><span>{item.sources}</span><p>{item.description}</p><small>{item.impact}</small></article>
                    ))}
                  </div>
