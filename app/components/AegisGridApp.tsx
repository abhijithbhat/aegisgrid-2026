  ...
  useEffect(() => {
    ...
    stream.addEventListener("incident", (event) => {
      try {
        ...
        /* malformed provider state is ignored at the UI boundary */
      }
    });
            ...
            <main className="workspace-view command-view">
              <div className="command-heading">
                <div>
                  ...
                  <p>
                    See what needs attention now, why it matters, and what requires your approval.
                  </p>
                </div>
                <div className="operational-state">
                  ...
                  <div>
                    ...
                    <strong>
                      {simulation.running ? "Scenario running" : "Heightened monitoring"}
                    </strong>
                    <span>
                      {simulation.running
              ...
              <section className="decision-brief" aria-labelledby="priority-focus-title">
                ...
                <aside
                  className="decision-action-card"
                  aria-label="Recommended supervisor decision"
                >
              ...
              <section className="kpi-grid" aria-label="Live synthetic event metrics">
                ...
                <article className="kpi-card">
                  ...
                  <footer>
                    <span>{responseEtas.length} routed incidents</span>
              ...
              <section className="signal-strip" aria-label="Current operational signals">
                ...
                <article className="recent-signal">
                  ...
                  <div>
                    <small>
                      MOST URGENT EVIDENCE · {recentEvidence?.source ?? "NO SOURCE"} ·{" "}
                      {topIncident.age}
                    </small>
                  ...
                  <button
                    ...
                    onClick={() => selectIncident(topIncident)}
